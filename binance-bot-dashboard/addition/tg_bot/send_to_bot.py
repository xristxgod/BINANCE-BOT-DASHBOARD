...
from addition.config import symbol, ADMIN_IDS, TOKEN
...
def send_to_user_bot_by_reg(chat_id: int, username: str):
    try:
        status = requests.get(f"https://api.telegram.org/bot{TOKEN}/sendMessage", params={
            "chat_id": chat_id,
